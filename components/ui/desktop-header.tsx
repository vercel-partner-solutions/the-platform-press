...
const TopHeaderBar = async ({ locale }: { locale: string }) => {
  ...
  return <div className="container mx-auto py-2 px-4 sm:px-6 lg:px-8 border-b border-neutral-100">
...
const MainHeaderBar = async ({ locale }: { locale: string }) => {
  return <div className="container mx-auto px-4 sm:px-6 lg:px-8 h-full">
